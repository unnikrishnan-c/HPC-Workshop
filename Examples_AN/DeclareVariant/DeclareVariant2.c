...
void avx2_saxpy(int, float, float *, float *);

#pragma omp declare variant(avx2_saxpy) match(device = {isa("core-avx2")})
...
void avx2_saxpy(int n, float s, float *x, float *y) // function variant
{
  // assume 64-byte alignment for AVX-2
